...
# CtfRefine
#########################################################
mpirun $RELION_CMD relion_ctf_refine_mpi --i ${RELION_OUTPUT_DIR}/Refine3D/run_data.star --f ${RELION_OUTPUT_DIR}/PostProcess/postprocess.star --o ${RELION_OUTPUT_DIR}/CtfRefine/ --fit_defocus --kmin_defocus 30 --fit_mode fpmff --fit_beamtilt --kmin_tilt 30 --j $RELION_CPUS_PER_TASK
